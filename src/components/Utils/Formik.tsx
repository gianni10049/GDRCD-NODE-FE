		...
		return (
			<>
				<Field
					name={props.name}
					as={'textarea'}
					className={`input h-20 resize-${resize} mt-1 w-full h-full bg-transparent border-b border-t border-green-border font-TecFont outline-0 text-green-border placeholder:text-green-border focus:text-green-light focus:placeholder:text-green-light hover:placeholder:text-green-light`}
					placeholder={props.placeholder}
				/>
				{/* @ts-ignore*/}
				<ErrorMessage name={props.name} render={renderError} />
